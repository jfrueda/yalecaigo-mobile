...
Future<void> logoutFromAccount(WidgetTester tester) async {
  ...
  // AccountOverviewPage devuelve directamente un ListView. En vez de buscar
  // su Scrollable interno (relacion que varia segun la version de Flutter),
  // se ejecuta el gesto sobre el ListView visible. El hit-test entrega el
  // gesto al Scrollable que implementa el desplazamiento real.
